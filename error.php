            ...
            <div class="card">
                <div class="card-body">
                    <div class="container-fluid text-center">
                        <img src="assets/ndma.png" class="my-1" width="100px" alt="National Disaster Management Authority">
                        <p class="lead mt-2"><strong>जिल्हा आपत्ती व्यवस्थापन प्राधिकरण जिल्हाधिकारी कार्यालय परभणी</strong></p>
                    </div>
                </div>
            </div>
        </div>
