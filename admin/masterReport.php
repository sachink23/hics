...
try {
    ...
    $subdists[] = ["Parbhani" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];

    $subdists[] = ["Jintur" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];

    $subdists[] = ["Pathri" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];

    $subdists[] = ["Manwath" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];
    $subdists[] = ["Purna" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];
    $subdists[] = ["Selu" => array(
    ...
    $subdists[] = ["Sonpeth" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];

    $subdists[] = ["Palam" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];

    $subdists[] = ["Gangakhed" => array(
        "g" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0],
        "p" => ["hosp" => 0, "rep_hosps" => 0, "no_opd" => 0, "no_cov" => 0, "no_ipd" => 0, "no_surgeries" => 0]
    )];
    $i = 0;
