...
<footer class="page-footer orange">
    <div class="container">
        <div class="row">
            <div class="col s12">
                <h6 class="white-text center text-padding">निर्मिती : जिल्हा आपत्ती व्यवस्थापन प्राधिकरण परभणी,
                    जिल्हाधिकारी कार्यालय, परभणी</h6>
            </div>
            ...
            <div class="col s12 center">
                ...
                <img align="center" src="../assets/logo/gom.png" class="m-2" alt="Goverment of Maharashtra"
                     width="80px">
